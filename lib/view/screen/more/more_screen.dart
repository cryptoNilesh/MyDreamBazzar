            ...
            builder: (context, profile, child) {
              return Row(children: [
                Padding(
                  ...
                  child: Image.asset(
                    Images.logo_with_name_image, height: 35,
                          ...
                          Expanded(
                            child: ListView(
                                ...
                                children: [
                                  ...
                                  // SquareButton(
                                  //     image: Images.wallet,
                                  //     title: "Wallet repaymnet",
                                  //     navigateTo: WalletRepaymentScreen(),
                                  //     count: 1,
                                  //     hasCount: false),
                                  SquareButton(
                                      image: Images.wallet,
                                      title: "My Team",
                                      navigateTo: MyTeamScreen(),
                                      count: 1,
                                      hasCount: false),
                                  SquareButton(
                                      image: Images.wallet,
                                      title: "My Bank Detail Screen",
                                      navigateTo: MyBankDetailScreen(index: 0),
                                      count: 1,
                                      hasCount: false),
                                  SquareButton(
                                      image: Images.wallet,
                                      title: "My Withdrawal",
                                      navigateTo: MyWithdrawalScreen(),
                                      count: 1,
                                      hasCount: false),
