...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  TextEditingController _refersIdController = TextEditingController();
  ...
  FocusNode _referFocus = FocusNode();
  ...
  addUser() async {
    if (_formKey.currentState.validate()) {
      ...
      String _referId = _refersIdController.text.trim();
      ...
      if(_referId.isEmpty)
        {
          _refersIdController.text="1234567890";
        }
      ...
      if (_firstName.isEmpty) {
        ...
        register.referid = _refersIdController.text;
        ...
        print(register.toString()+"hiiiiii");
      }
    } else {
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: CustomTextField(
                      hintText: getTranslated('refer_id', context),
                      focusNode: _referFocus,
                      nextNode: _emailFocus,
                      capitalization: TextCapitalization.words,
                      controller: _refersIdController,
                    )),
                  ],
                ),
              ),
