...
class ProductDetailsModel {
  ...
  ProductDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    _variantProduct = json['variant_product']==null?0:int.parse(json['variant_product'].toString());
    ...
    _averageReview = json['average_review']==null?"0":json['average_review'].toString();
