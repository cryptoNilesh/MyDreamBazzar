...
class BankEditApi {
  Future<dynamic> onBankEditApi(String accountname, String accountnumber,
      String ifsc, String extra, String extra2, String user_id, String id) async {
    try {
      final uri =
          Uri.parse(AppConstants.BASE_URL+'/api/v1/bank-edit');
