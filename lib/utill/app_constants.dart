...
class AppConstants {
  static const String APP_NAME = 'MY DREAM BAZZAR';
  static const String APP_VERSION = '69';
   // static const String BASE_URL = 'https://test.mydreambazzar.in';
  static const String BASE_URL = 'https://mydreambazzar.in';
  ...
  static const String CUSTOMER_URI1 = '/api/v1/info?user_id=';
  ...
  static const String WALLET_TRANSACTION_URI =
      'api/v1/user-transaction-history-list';
  ...
  static const String MANISH_API = 'https://mydreambazzar.in/api/v1/customer/referals';
